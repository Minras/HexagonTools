...
HT.Grid.prototype.GetHexId = function(row, col) {
    var letterIndex = row,
        letters = "",
        lettersCount = HT.Grid.Static.Letters.length;

    while(letterIndex > lettersCount - 1) {
        letters = HT.Grid.Static.Letters[letterIndex % lettersCount] + letters;
        letterIndex -= lettersCount;
    }
